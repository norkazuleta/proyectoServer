...
define(function() {
    ...
    var ChangePasswordController = function($scope, UserService, RestWrapper, progression, notification, TranslationService) {
        this.$scope = $scope;
    ...
    ChangePasswordController.prototype.submitEdition = function($event, restEntry) {
        ...
        this.rest
            .updateOne(restEntry, 'profile', '/api/profile/change-password')
            .then(() => {
                ...
                this.$scope.user.plainPassword.first = '';
                this.$scope.user.plainPassword.second = '';
            }, this.handleError.bind(this));
    };

    ChangePasswordController.prototype.validateEntry = function() {
        if (!this.form.$valid) {
    ...
    ChangePasswordController.prototype.resetMsg = function() {
        this.$scope.msg = {
            plainPassword: {
                first: '',
                second: ''
    ...
    ChangePasswordController.prototype.handleError = function(response) {
    ...
    ChangePasswordController.prototype.destroy = function() {
    ...
    ChangePasswordController.$inject = ['$scope', 'UserService', 'RestWrapper', 'progression', 'notification', 'TranslationService'];
