...
use AppBundle\Form\UnidadCurricularType;
...
/**
 * UnidadCurricular controller.
 * @RouteResource("UnidadCurricular")
 */
class UnidadCurricularRESTController extends VoryxController
{
    /**
     * Get a UnidadCurricular entity
     *
     ...
     *
     */
    public function getAction(UnidadCurricular $entity)
    {
        return $entity;
    }
    /**
     * Get all UnidadCurricular entities.
     *
     * @View(serializerEnableMaxDepthChecks=true)
     *
    ...
    /**
     * Create a UnidadCurricular entity.
     *
    ...
    public function postAction(Request $request)
    {
        ...
        $form = $this->createForm(new UnidadCurricularType(), $entity, array("method" => $request->getMethod()));
    ...
    /**
     * Update a UnidadCurricular entity.
     *
     * @View(serializerEnableMaxDepthChecks=true)
     *
     * @param Request $request
     ...
     * @return Response
     */
    public function putAction(Request $request, UnidadCurricular $entity)
    {
        try {
            $em = $this->getDoctrine()->getManager();
    ...
    /**
     * Partial Update to a UnidadCurricular entity.
     *
     * @View(serializerEnableMaxDepthChecks=true)
     *
     * @param Request $request
     ...
     * @return Response
     */
    public function patchAction(Request $request, UnidadCurricular $entity)
    {
        return $this->putAction($request, $entity);
    }
    /**
     * Delete a UnidadCurricular entity.
     *
     * @View(statusCode=204)
     *
     * @param Request $request
     ...
     * @return Response
     */
    public function deleteAction(Request $request, UnidadCurricular $entity)
    {
        try {
            $em = $this->getDoctrine()->getManager();
            $em->remove($entity);
