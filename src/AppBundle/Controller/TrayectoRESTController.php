...
use AppBundle\Form\TrayectoType;
...
/**
 * Trayecto controller.
 * @RouteResource("Trayecto")
 */
class TrayectoRESTController extends VoryxController
{
    /**
     * Get a Trayecto entity
     *
     ...
     *
     */
    public function getAction(Trayecto $entity)
    {
        return $entity;
    }
    /**
     * Get all Trayecto entities.
     *
     * @View(serializerEnableMaxDepthChecks=true)
     *
    ...
    public function cgetAction(ParamFetcherInterface $paramFetcher, Request $request)
    {
        try {
            ...
            $entity = $em->getRepository('AppBundle:Trayecto');
    ...
    {
        $entity = new Trayecto();
        $form = $this->createForm(new TrayectoType(), $entity, array("method" => $request->getMethod()));
     ...
     * @return Response
     */
    public function putAction(Request $request, Trayecto $entity)
    {
        try {
            $em = $this->getDoctrine()->getManager();
    ...
    /**
     * Partial Update to a Trayecto entity.
     *
     * @View(serializerEnableMaxDepthChecks=true)
     *
     * @param Request $request
     ...
     * @return Response
     */
    public function patchAction(Request $request, Trayecto $entity)
    {
        return $this->putAction($request, $entity);
    }
    /**
     * Delete a Trayecto entity.
     *
     * @View(statusCode=204)
     *
     * @param Request $request
     ...
     * @return Response
     */
    public function deleteAction(Request $request, Trayecto $entity)
    {
        try {
            $em = $this->getDoctrine()->getManager();
            $em->remove($entity);
