...
/**
 * Periodo controller.
 * @RouteResource("Periodo")
 */
class PeriodoRESTController extends VoryxController
{
    /**
     * Get a Periodo entity
     *
     ...
     *
     */
    public function getAction(Periodo $entity)
    {
        return $entity;
    }
    /**
     * Get all Periodo entities.
     *
     * @View(serializerEnableMaxDepthChecks=true)
     *
    ...
    public function cgetAction(ParamFetcherInterface $paramFetcher, Request $request)
    {
        try {
            ...
            $entity = $em->getRepository('AppBundle:Periodo');
            if (!empty($q)) {
                $filters = array(
                    'periDesc' => '',
                );
    ...
    {
        $entity = new Periodo();
        $form = $this->createForm(new PeriodoType(), $entity, array("method" => $request->getMethod()));
     ...
     * @return Response
     */
    public function putAction(Request $request, Periodo $entity)
    {
        try {
            $em = $this->getDoctrine()->getManager();
    ...
    /**
     * Partial Update to a Periodo entity.
     *
     * @View(serializerEnableMaxDepthChecks=true)
     *
     * @param Request $request
     ...
     * @return Response
     */
    public function patchAction(Request $request, Periodo $entity)
    {
        return $this->putAction($request, $entity);
    }
    /**
     * Delete a Periodo entity.
     *
     * @View(statusCode=204)
     *
     * @param Request $request
     ...
     * @return Response
     */
    public function deleteAction(Request $request, Periodo $entity)
    {
        try {
            $em = $this->getDoctrine()->getManager();
            $em->remove($entity);
