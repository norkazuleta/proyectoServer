 ...
 * @RouteResource("Zona")
 */
class ZonaRESTController extends VoryxController
{
    /**
     * Get a Zona entity.
     *
     ...
     * @return Response
     */
    public function getAction(Zona $entity)
    {
        return $entity;
    }
    /**
     * Get all Zona entities.
     *
     * @View(serializerEnableMaxDepthChecks=true)
     *
    ...
    public function cgetAction(ParamFetcherInterface $paramFetcher, Request $request)
    {
        try {
            ...
            $entity = $em->getRepository('AppBundle:Zona');
    ...
    {
        $entity = new Zona();
        $form = $this->createForm(new ZonaType(), $entity, array('method' => $request->getMethod()));
     ...
     * @return Response
     */
    public function putAction(Request $request, Zona $entity)
    {
        try {
            $em = $this->getDoctrine()->getManager();
    ...
    /**
     * Partial Update to a Zona entity.
     *
     * @View(serializerEnableMaxDepthChecks=true)
     *
     * @param Request $request
     ...
     * @return Response
     */
    public function patchAction(Request $request, Zona $entity)
    {
        return $this->putAction($request, $entity);
    }
    /**
     * Delete a Zona entity.
     *
     * @View(statusCode=204)
     *
     * @param Request $request
