 ...
 * @RouteResource("Pnf")
 */
class PnfRESTController extends VoryxController
{
    /**
     * Get a Pnf entity
     *
     ...
     *
     */
    public function getAction(Pnf $entity)
    {
        return $entity;
    }
    /**
     * Get all Pnf entities.
     *
     * @View(serializerEnableMaxDepthChecks=true)
     *
    ...
    public function cgetAction(ParamFetcherInterface $paramFetcher, Request $request)
    {
        try {
            ...
            $entity = $em->getRepository('AppBundle:Pnf');
            if (!empty($q)) {
                $filters = array(
                    'pnfDesc' => '',
                );
    ...
    {
        $entity = new Pnf();
        $form = $this->createForm(new PnfType(), $entity, array("method" => $request->getMethod()));
     ...
     * @return Response
     */
    public function putAction(Request $request, Pnf $entity)
    {
        try {
            $em = $this->getDoctrine()->getManager();
    ...
    /**
     * Partial Update to a Pnf entity.
     *
     * @View(serializerEnableMaxDepthChecks=true)
     *
     * @param Request $request
     ...
     * @return Response
     */
    public function patchAction(Request $request, Pnf $entity)
    {
     ...
     * @return Response
     */
    public function deleteAction(Request $request, Pnf $entity)
    {
        try {
            $em = $this->getDoctrine()->getManager();
            $em->remove($entity);
